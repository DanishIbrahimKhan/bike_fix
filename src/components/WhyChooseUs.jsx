      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center mb-10">
          <div className="flex flex-col items-center">
            <FaMotorcycle size={30} className="text-yellow-400 mb-2" />
            <p className="text-sm font-medium">Free Pickup & Drop</p>
          </div>
          <div className="flex flex-col items-center">
            <FaTools size={30} className="text-yellow-400 mb-2" />
            <p className="text-sm font-medium">Trained Mechanic</p>
          </div>
          <div className="flex flex-col items-center">
            <FaShieldAlt size={30} className="text-yellow-400 mb-2" />
            <p className="text-sm font-medium">10 Days Warranty</p>
          </div>
          <div className="flex flex-col items-center">
            <FaCogs size={30} className="text-yellow-400 mb-2" />
            <p className="text-sm font-medium">Genuine Spare Parts</p>
          </div>
        </div>

        {/* Description */}
        <div className="text-gray-300 text-sm leading-6 space-y-4">
